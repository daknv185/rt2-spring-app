...
public class SearchForEmployeesByDepartmentService {
	 ...
	 */
	public //TODO ここに記述
	List<EmployeeBean> execute(Integer deptId){
		
		Department dept = new Department();
		dept.setDeptId(deptId);
		List<Employee>deptSearch = repository.findByDepartmentOrderByEmpId(dept);
		List<EmployeeBean>resSearch = BeanManager.copyEntityListToBeanList(deptSearch);
